...
**After 3 post failures** you're schedule will be marked as **_disabled_**! To re-enable a schedule that has been disabled you'll have to access your [Bot Dashboard](https://sessionsbot.fyi/dashboard).
