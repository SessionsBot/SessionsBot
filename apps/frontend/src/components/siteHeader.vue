<script setup lang="ts">
    ...
    watch(() => nav.systemStatus.state, (v) => {
        if (v?.data.data?.showStatusAlert) {
            console.info('It appears some of our internal systems may be experiencing some connectivity issues. View more at https://status.sessionsbot.fyi', nav.systemStatus.state)
