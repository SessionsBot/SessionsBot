    ...
    <div class="flex flex-col gap-4 justify-start items-center">
        ...
        <div class="pricing-plan-cards-wrap">
            ...
            <div v-for="plan in planDetails" :key="plan.title"
                class="bg-black/30 border-2 gap-2 min-w-50 max-w-60 grow flex-1 border-ring rounded-md flex flex-col items-center justify-center">
                <!-- Title & Desc & Price -->
...
<style scoped>
    ...
    .pricing-plan-cards-wrap {
        @apply w-full h-fit flex flex-wrap gap-5 px-7 p-3 items-start justify-center;
    }
