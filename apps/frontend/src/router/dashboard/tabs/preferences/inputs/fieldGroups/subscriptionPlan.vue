        ...
        <div class="input">
            ...
            <RouterLink :to="`/pricing?guild=${dashboard?.guildId}`" class="w-full">
                <div title="Open Plan Details"
                    class="relative h-11 w-full p-1.25 py-1.5 gap-px bg-(--input-background) flex items-center justify-stretch border-2 border-ring-soft hover:border-indigo-300 active:border-indigo-400 transition-all cursor-pointer rounded-md">
