/** The user identity data returned back from the user identity endpoint. */
...
/** The guild identity data returned back from the guild identity endpoint. */
...
/** The user identity data returned back from the SELF identity endpoint. */
export type API_DiscordSelfIdentity = {
